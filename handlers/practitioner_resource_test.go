...
func TestUnitHandleCreatePractitionersResource(t *testing.T) {
	...
	Convey("Incoming request has an invalid role", t, func() {
		...
		mockService.EXPECT().GetInsolvencyResource(gomock.Any()).Return(generateInsolvencyPractitionerAppointmentResources(), nil)
...
func TestUnitHandleGetPractitionerResource(t *testing.T) {
	...
	Convey("Error when retrieving a practitioner resource from the DB", t, func() {
		...
		mockService := mock_dao.NewMockService(mockCtrl)
		// Expect GetPractitionersAppointmentResource to return an error
		mockService.EXPECT().GetPractitionersAppointmentResource(gomock.Any(), gomock.Any()).Return(practitionerResourceDaos, fmt.Errorf("error retrieving practitioner"))
	...
	Convey("Practitioner resource not found", t, func() {
		...
		mockService := mock_dao.NewMockService(mockCtrl)
		// Expect GetPractitionersAppointmentResource to return an empty practitioner resource
	...
	Convey("Successfully retrieve practitioner resource", t, func() {
		...
		mockService := mock_dao.NewMockService(mockCtrl)
		// Expect GetPractitionersAppointmentResource to successfully return a practitioner resource
		mockService.EXPECT().GetPractitionersAppointmentResource(gomock.Any(), gomock.Any()).Return(practitionerResourceDaos, nil)
...
func TestUnitHandleAppointPractitioner(t *testing.T) {
	...
	Convey("invalid made_by field supplied", t, func() {
		...
		mockService.EXPECT().GetPractitionersAppointmentResource(gomock.Any(), gomock.Any()).Return(nil, fmt.Errorf("error"))
	...
	Convey("appointment date invalid - date differs", t, func() {
		...
		practitionersDao.Data.Appointment = &appointmentResourceDao

		insolvencyDao := models.InsolvencyResourceDaoData{}
		insolvencyDao.Data.CompanyNumber = "1234"
		insolvencyDao.Data.CaseType = "CVL"
		insolvencyDao.Data.CompanyName = "Company"
		insolvencyDao.Data.Practitioners = append(insolvencyDao.Data.Practitioners, practitionersDao)
