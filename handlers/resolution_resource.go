...
func HandleCreateResolution(svc dao.Service, helperService utils.HelperService) http.Handler {
	return http.HandlerFunc(func(w http.ResponseWriter, req *http.Request) {
		...
		validationErrs := service.ValidateResolutionRequest(request)
		isValidStatementDetails, httpStatusCode := helperService.HandleStatementDetailsValidation(w, req, transactionID, validationErrs, nil)
