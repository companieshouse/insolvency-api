...
type Config struct {
	...
	EnableNon600RouteHandlers  bool   `env:"ENABLE_NON600_ROUTE_HANDLERS"     flag:"enable-non600-route-handlers"   flagdesc:"Set to 'true'/'false' to respectively enable/disable LRESEX and LIQ02 form endpoints"`
}
